...
CUDA_FLAGS=-DUSE_CUDA -Wno-deprecated-gpu-targets -rdc=true -lcusparse -arch=sm_80 -lineinfo -fmad=true -use_fast_math -maxrregcount=64 #-Wall -Wextra -Wpedantic -mavx2
